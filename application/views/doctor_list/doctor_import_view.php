      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Add</h3>
			<a class="sample-file-link btn btn-info pull-right" href="<?php echo site_url('assets/sample file/Doctor Import.csv')?>" download>Download Sample File</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
