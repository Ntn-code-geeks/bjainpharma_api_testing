...
<!--                 </div>
                ...
                <tr >
				  ...
				  <?php if($order_amount!=''){?>
                 <td id="sale<?=$edit_pharmacy->id ?>" style="display: block"><input class="form-control" readonly id="sale_dealer<?=$edit_pharmacy->id;?>" name="m_sale" value='<?=$order_amount?>' type="text" ></td> 
				<?php }else{?>
					<td id="sale<?=$edit_pharmacy->id ?>" style="display: block">
                ...
                <tr >
                  <td>Sample</td>
                  <td id="sample<?=$edit_pharmacy->id ?>" style="display: block"><select name="m_sample[]" multiple="multiple" class="form-control select2" style="width: 100%;">
                          <option value="">---Sample Name---</option>
                <?php 
              ...
              <!--<option value="none" id="none" >NONE</option>-->
                ...
                <tr >
                  ...
                  <td><div class="radio">
                    ...
                    <label id="notmmeet<?=$edit_pharmacy->id ?>" style="display: block">
                      <input name="meet_or_not" id="not_meet<?=$edit_pharmacy->id ?>" value="0" type="radio">
                      Not Met
                    </label>
                  </div>
                  </td>
                ...
                <tr >
                    ...
                    <label id="telephonic<?=$edit_pharmacy->id ?>"style="display: <?php echo $order_amount!=''?'block':'none'?>">Telephonic Interaction
