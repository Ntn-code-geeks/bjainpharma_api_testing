...
<!--          <div class="box-tools pull-right">
        ...
        <div class="box-body">
           ...
           <form role="form" method="post"   action="<?php echo base_url()."interaction/update_pharma_interaction/".$pharma_interaction['pharmacy_info'][0]['id']?>" enctype= "multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group" >
                 ...
                 <input class="form-control" name="com_name" placeholder="Sub Dealer Name..." type="text" value="<?=$pharma_interaction['pharmacy_info'][0]['customer'];?>" readonly="">               
                 <input class="dealer_view_id"  name="dealer_view_id" type="hidden" value="<?=$pharma_interaction['pharmacy_info'][0]['pharma_id'];?>"> 
                <input class="gd_id"  name="pharma_id" type="hidden" value="<?=$pharma_interaction['pharmacy_info'][0]['pharma_id'];?>">                  
            <!--<span class="control-label" for="inputError" style="color: red"></span>-->
                 </div>                
             
             
             <div class="form-group" id="jw_<?=$pharma_interaction['pharmacy_info'][0]['id'] ?>" style="display: block">
             ...
             <div class="form-group">
                     ...
                     <textarea class="form-control" rows="3" name="remark" placeholder="About the Meeting ..."><?=$pharma_interaction['pharmacy_info'][0]['remark']?></textarea>
                ...
                <tr>
                  ...
                  <td id="sale" style="display: block"><input readonly class="form-control" id="sale_dealer" name="m_sale" placeholder="Sales info..." type="text" value="<?=$pharma_interaction['pharmacy_info'][0]['secondary_sale']?>" >
                 <!--  <a href="<?php echo base_url()."order/interaction_order/add_order/". urisafeencode($pharma_interaction['pharmacy_info'][0]['id']).'/'. urisafeencode($pharma_interaction['pharmacy_info'][0]['pharma_id']);?>"><button type="button" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a> -->
                ...
                <?php 
                     ...
                     $samples_id = explode(',',$pharma_interaction['pharmacy_info'][0]['sample']['sample_id']);
                ...
                <tr >
                  ...
                  <td><div class="radio">
                    <label id="meet" style="display: block">
                        ...
                        if($pharma_interaction['pharmacy_info'][0]['metnotmet']==TRUE){echo "checked"; }
                        ?>>
                ...
                <tr >
                    ...
                    <label id="notmmeet" style="display: block">
                      ...
                      <input name="meet_or_not" id="not_meet" value="0" type="radio"  <?php 
                        if($pharma_interaction['pharmacy_info'][0]['metnotmet']==FALSE && $pharma_interaction['pharmacy_info'][0]['metnotmet']!=NULL){ echo "checked"; }
                        ?>>
         ...
         <div class="col-md-6">
             ...
             <div class="form-group" >
                   ...
                   <input class="form-control" name="doi_doc" id="datepicker_doi" type="text" value="<?=date('d-m-Y',strtotime($pharma_interaction['pharmacy_info'][0]['date']));?>">
                      </div> 
...
//           if(!empty($doc_interaction['doc_info'][0]['dealers_id'])){
       ...
       <select id="dealer_id" name="dealer_id" class="form-control select2" style="width: 100%;">
                ...
                foreach($dealer_data as $k_s => $val_s){
                     ...
                     if($val_s->dealer_id==$pharma_interaction['pharmacy_info'][0]['dealer_id']){
           ...
           <!--Gender and merried status-->
            <div class="col-md-6">
                      ...
                      <div class="form-group" >
                          ...
                          <input class="form-control" name="fup_a" id="datepicker_fup" type="text" value="<?=!empty($pharma_interaction['pharmacy_info'][0]['fup_a']) ? date('d-m-Y',strtotime($pharma_interaction['pharmacy_info'][0]['fup_a'])):'';?>">
                      </div>
