    ...
    <?php echo get_flash(); ?>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Transit Plan</h3>
						...
						<select name="source_city" id="source_city"  class="form-control select2" style="width: 100%;">
						  <option value="">--Select Source City --</option>
							<?php foreach($city_list as $city){ ?>   
								<option <?php echo ($city['id']==$transit_data[0]['source'])?'selected':'';?> value="<?=$city['id']?>" ><?=get_city_name($city['id'])?></option>
							<?php }  ?>
						</select>
					...
					<div class="form-group">
						...
						<select name="dest_city" id="dest_city"  class="form-control select2" style="width: 100%;">
						  <option value="">--Select Destination City--</option>
							<?php foreach($city_list as $city){ ?>   
								<option <?php echo ($city['id']==$transit_data[0]['destination'])?'Selected':''; ?> value="<?=$city['id']?>" ><?=get_city_name($city['id'])?></option>
							<?php }  ?>
						</select>
