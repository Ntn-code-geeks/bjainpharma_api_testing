            ...
            <div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input class="form-control" type="number"  value="<?php echo set_value('city_fare') ?>" name="city_fare" placeholder="Enter Fare In INR ..." type="text" value="">               
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input class="form-control" value="<?php echo set_value('city_distance') ?>" type="text" name="city_distance" placeholder="Enter Distance in KM ..." type="text" value="">               
