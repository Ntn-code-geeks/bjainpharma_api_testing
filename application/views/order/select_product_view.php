      ...
      <div class="box box-default">
        ...
        <div class="box-body">
			...
			<div class="form-group">
				...
				<input class="form-control" name="payment" placeholder="Enter payment terms" value="" required type="text">               
	         </div>
			</div>
...
<script type='text/javascript'>
    $(".add_row").on("click", function(e) {
    	...
    	if(catid==11 || catid==9 || catid==8)
    	{
    	 ...
    	 else if(catid==1 || catid==2 || catid==3 || catid==4 || catid==6 || catid==10 || catid==7)
    	 {
