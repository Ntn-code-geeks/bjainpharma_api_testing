    ...
    <?php echo get_flash(); ?>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Add Other Transit Plan</h3>
						...
						<select name="source_city" id="source_city"  class="form-control select2" style="width: 100%;">
						  <option value="">--Select Source City --</option>
							<?php foreach($city_list as $city){ ?>   
								<option  <?php echo set_select('source_city', $city['city_id']); ?> value="<?=$city['city_id']?>" ><?=$city['city_name']?></option>
							<?php }  ?>
						</select>
					...
					<div class="form-group">
						...
						<select name="dest_city" id="dest_city"  class="form-control select2" style="width: 100%;">
						  <option value="">--Select Destination City--</option>
							<?php foreach($city_list as $city){ ?>   
								<option  <?php echo set_select('dest_city', $city['city_id']); ?> value="<?=$city['city_id']?>" ><?=$city['city_name']?></option>
							<?php }  ?>
						</select>
					...
					<div class="bootstrap-timepicker">
						<div class="form-group">
						  ...
						  <div class="input-group">
							<input readonly type="text" name="transit_st_time" id="transit_st_time" class="form-control timepicker">
