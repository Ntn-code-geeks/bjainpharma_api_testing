...
<div class="content-wrapper">
    ...
    <?php echo get_flash(); ?>
      ...
      <div class="box box-default">
		...
		<a class="sample-file-link btn btn-info pull-right" href="<?php echo site_url('assets/sample file/Sub Dealer Import.csv')?>" download>Download Sample File</a>
