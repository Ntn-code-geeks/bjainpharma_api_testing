...
<div class="content-wrapper">
    ...
    <?php echo get_flash(); ?>
      ...
      <div class="box box-default">
		...
		<a class="sample-file-link btn btn-info pull-right" href="<?php echo site_url('assets/sample file/Tour Plan Data.csv')?>" download>Download Sample File</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
...
//            xss_clean();?>
			...
			<div class="row">
				<div class="col-md-6">
				   <div class="form-group">
					<label>Import Tour Plan Data *</label>
