 ...
 public function show_tada_report($userid,$start,$end)
  {
      ...
      $this->excel->getActiveSheet()->getStyle('A5:P5')->applyFromArray($styleArray);
      $this->excel->getActiveSheet()->getStyle('A5:P5')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('FFFF00');
      $this->excel->getActiveSheet()->mergeCells('A1:P2');
      $this->excel->getActiveSheet()->getStyle('A1:P2')->applyFromArray($styleArray1);
      $this->excel->getActiveSheet()->getStyle('A1:P2')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('FFFF00');
      ...
      $this->excel->getActiveSheet()->mergeCells('D3:J4');
      $this->excel->getActiveSheet()->getStyle('D3:J4')->applyFromArray($styleArray2);
      $this->excel->getActiveSheet()->getStyle('D3:J4')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('32CD32');
      $this->excel->getActiveSheet()->getStyle('D3')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
      $this->excel->getActiveSheet()->setCellValue('D3', 'EXPENSE STATEMENT By STP');
      ...
      $this->excel->getActiveSheet()->mergeCells('P3:P3');
      $this->excel->getActiveSheet()->getStyle("P3:P3")->applyFromArray($styleArray);
      $this->excel->getActiveSheet()->setCellValue('P3', 'FROM : '.date('d/m/Y',strtotime($start)));
      $this->excel->getActiveSheet()->mergeCells('P4:P4');
      $this->excel->getActiveSheet()->getStyle("P4:P4")->applyFromArray($styleArray);
      $this->excel->getActiveSheet()->setCellValue('P4', 'TO : '.date('d/m/Y',strtotime($end)));
      ...
      $this->excel->getActiveSheet()->setCellValue('K5', 'KMS');
      $this->excel->getActiveSheet()->setCellValue('L5', 'T.A.');
      $this->excel->getActiveSheet()->setCellValue('M5', 'D.A.');
      $this->excel->getActiveSheet()->setCellValue('N5', 'POSTAGE');
      $this->excel->getActiveSheet()->setCellValue('O5', 'TOTAL');
      $this->excel->getActiveSheet()->setCellValue('P5', 'Remark');
     ...
     /* pr($data['tada_report']);
        ...
        //if($key==0 || ($data['tada_report'][$key-1]['destination_city']!=$r)ow['destination_city'] && $data['tada_report'][$key-1]['source_city']!=$row['source_city'])){ 
          $da=0;
          $hqdistance=0;
          $nxtdestination=0;
          ...
          if($row['source_city']==$row['destination_city'])
          {
            ...
            {
              $this->excel->getActiveSheet()->setCellValue('K'.$k_num, $row['distance']);
              $this->excel->getActiveSheet()->setCellValue('L'.$k_num, $row['stp_ta']);
              $this->excel->getActiveSheet()->setCellValue('F'.$k_num, $row['stp_distance']);
          ...
          $gtstprow=$gtstprow+$totalstprow;
          $gtstpta=$gtstpta+$row['stp_ta'];
          $k_num++;
      ...
      $this->excel->getActiveSheet()->setCellValue('A'.$k_num, 'Total Payable Amount :- Rs. '.$gtstprow);
      ...
      $this->excel->getActiveSheet()->getStyle("A1:P".$extra)->applyFromArray($styleArray1);
